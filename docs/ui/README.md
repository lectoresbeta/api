...
| [read-chapter.md](read-chapter.md) | Leer un capítulo, comentarlo y **corregirlo** con el cuestionario del autor | `FEAT-FBK-003`, `FEAT-FBK-011`, `FEAT-WRK-014`, `FEAT-COM-036`, `FEAT-CRD-016` | `DRAFT` |
