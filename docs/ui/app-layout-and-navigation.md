...
> El «12» del diseño es dato de maqueta. Una cuenta recién activada tiene **10**
> (`FEAT-CRD-002`), y una sin activar tiene **0** (`FEAT-USR-025`).
>
> **Es un solo número: el saldo.** No hay «disponible» que distinguir, porque el sistema no
> retiene créditos ([`decision:0006`](../decisions/0006-credit-system.md)). `R-5` queda
> resuelta al desaparecer la distinción.
>
> Lo que sí puede mostrar es **un número negativo**, y ese caso el diseño no lo contempla: un
> autor en descubierto verá algo como «−6 Créditos» y necesita entender qué significa y cómo
> salir (`L-6`).
...
El saldo es **un solo número**, que puede ser negativo
...
| L-6 | ¿Cómo se muestra un saldo **negativo** en el bloque de créditos? | Un autor en descubierto necesita entender qué significa y cómo salir |
