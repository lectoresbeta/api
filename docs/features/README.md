...
| FEAT-RDG-004 | Invitar a un usuario a ser LB de una obra | Writer | APPROVED | TODO | P1 | [ficha](reading/FEAT-RDG-004-invite-beta-reader.md) |
| FEAT-RDG-005 | Aceptar o rechazar una invitación de LB | Reader | APPROVED | TODO | P1 | [ficha](reading/FEAT-RDG-005-resolve-invitation.md) |
