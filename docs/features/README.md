...
| FEAT-USR-036 | Purga programada de alias caducados | — (sistema) | APPROVED | DONE | P2 | [ficha](user/FEAT-USR-036-purge-expired-aliases.md) |
...
| FEAT-COM-026 | Mi muro — publicaciones propias | User | APPROVED | DONE | P2 | [ficha](community/FEAT-COM-026-a-persons-wall.md) |
