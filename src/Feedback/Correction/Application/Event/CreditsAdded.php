...
/**
 * `CreditsAdded`, tal y como lo modela `Feedback` (`FEAT-FBK-010`).
 *
 ...
 */
final readonly class CreditsAdded implements IncomingIntegrationEvent
{
    ...
    public static function fromPayload(string $eventId, \DateTimeImmutable $occurredAt, array $payload): self
    {
        ...
        if (!\is_string($userId) || !\is_int($amount) || !\is_string($reason)) {
            throw new \InvalidArgumentException('CreditsAdded carries no user, amount or reason.');
        }
