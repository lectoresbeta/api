...
/**
 * `FeedbackReplied`, tal y como lo modela `Notification`.
 *
 ...
 */
final readonly class FeedbackReplied implements IncomingIntegrationEvent
{
    ...
    public static function fromPayload(string $eventId, \DateTimeImmutable $occurredAt, array $payload): self
    {
        ...
        if (!\is_string($correctionId) || !\is_string($workId) || !\is_string($chapterId) || !\is_string($readerId)) {
            throw new \InvalidArgumentException('FeedbackReplied carries no correction, work, chapter or reader.');
        }
