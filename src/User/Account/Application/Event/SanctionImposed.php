...
/**
 * `SanctionImposed`, tal y como lo modela `User`.
 *
 * Una clase distinta de la que publica `Moderation`, a propósito
 * ([`decision:0013`](../../../../../docs/decisions/0013-integration-events-travel-without-class-names.md)).
 *
 * De todo lo que trae, aquí importan tres cosas: a quién, de qué tipo y hasta
 * cuándo. El motivo viaja igualmente porque es `Notification` quien se lo
 * cuenta a la persona, y una sanción que no se entiende no corrige nada.
 */
