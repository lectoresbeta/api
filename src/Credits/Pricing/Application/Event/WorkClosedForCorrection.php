...
/**
 * `WorkClosedForCorrection`, tal y como lo modela `Credits` (`FEAT-WRK-016`).
 *
 ...
 */
final readonly class WorkClosedForCorrection implements IncomingIntegrationEvent
{
    ...
    public static function fromPayload(string $eventId, \DateTimeImmutable $occurredAt, array $payload): self
    {
        ...
        if (!\is_string($workId) || '' === $workId || !\is_int($version)) {
            throw new \InvalidArgumentException('WorkClosedForCorrection needs a work and a version.');
        }
